...
public class Rational implements Comparable<Rational> {
    ...
    public int compareTo(Rational other) {
        ...
        //		return BigInteger.valueOf(numerator).multiplyX(BigInteger.valueOf(other.denominator)).compareTo(
        //			BigInteger.valueOf(other.numerator).multiplyX(BigInteger.valueOf(denominator)));
    }
